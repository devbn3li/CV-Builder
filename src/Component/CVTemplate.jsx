    ...
    <section className="bg-white w-[21cm] h-[27.8cm] p-[50px]">
      <div className="flex gap-20">
        <div className="w-[150px] h-[150px] box-border rounded-full flex justify-center items-center overflow-hidden">
          ...
          <img src={userImageUrl} className="w-full" draggable="false" />
          {showImage && userImageUrl == "" && (
            <span className="min-w-full min-h-full text-white bg-gray-400/70 flex justify-center items-center text-8xl">
              <RiUserLine />
            </span>
          )}
          <img src={userImageUrl} className="w-full" draggable="false" />
        ...
        <div>
          <p
            className={`font-semibold ${
              userName.length > 10 ? "text-4xl" : "text-6xl"
            }  min-w-[220px]`}
          >
            {userName}
          </p>
      ...
      <div className=" flex gap-[15%] mt-[40px]">
        <div className=" grid gap-[20px] w-[40%] xd:block">
          <p className=" font-bold pb-[20px] border-b-[1px] border-sky-600 text-[30px]">
            Education
          </p>
        ...
        <div className="overflow-hidden">
          <p className=" font-bold pb-[20px] border-b-[1px] border-sky-600 mb-[15px] text-[30px]">
            {" "}
            Profile{" "}
          </p>

          <p className=" text-[20px] mb-[30px] word-wrap break-word overflow-wrap break-word whitespace-normal">
            {" "}
            {userAbout}{" "}
          </p>

          <p className="  font-bold pb-[20px] border-b-[1px] border-sky-600 text-[30px] mb-[55px] ">
            Experience
          </p>
          ...
          <div className="flex gap-[40px]">
            <div className="grid gap-[55px] xd:block">
              {employmentHistory.map((ele, idx) => (
                <div key={idx} className="overflow-hidden">
                  <p className="whitespace-normal text-slate-600 word-wrap break-word overflow-wrap">
                    {ele.startDate} - {ele.endDate}
                  </p>
            ...
            <div className="grid xd:block ">
              {employmentHistory.map((ele, idx) => (
                <div key={idx} className="overflow-hidden">
                  <p className=" font-bold text-[16px] word-wrap break-word overflow-wrap break-word whitespace-normal">
                    {ele.jobTitle}
                  </p>
                  <p className="whitespace-normal text-slate-600 word-wrap break-word overflow-wrap">
                    {ele.details}
