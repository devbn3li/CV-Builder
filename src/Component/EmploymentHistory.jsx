  ...
  return (
    <div className="py-3 border-b border-primary-800 w-full">
      <div className="flex justify-between px-6">
        <h2 className="font-semibold leading-8 text-base">
          Employment History
        </h2>
        <button
      ...
      <div
        className={`mt-6 flex flex-col gap-4 px-8 ${
      ...
      >
                ...
                <button
                  onClick={() =>
                    setEmploymentHistory(
                      employmentHistory.filter((ele, CIdx) => {
                        return CIdx != idx;
                      })
                    )
                  }
                  className="text-2xl leading-4 text-red-500 font-semibold"
                >
                  -
                </button>
              )}
        ...
        <button
          className="focus:outline-none text-blue-100 w-full text-start"
          onClick={() =>
            setEmploymentHistory([
              ...employmentHistory,
              {
